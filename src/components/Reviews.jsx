        ...
        <div className="container mx-auto flex items-center justify-center p-8 text-black">
            ...
            >
                <div className="px-4 md:p-2 flex flex-col items-center justify-center space-y-2">
                    <img src={Img1} className="w-24 md:w-32" alt="Customer 1" />
                    ...
                    <p className="text-lg md:max-w-md text-center">
                        I am a big fan of the customer experience.
                    </p>
                ...
                <div className="p-2 flex flex-col items-center justify-center space-y-2">
                    <img src={Img2} className="w-32" alt="Customer 2" />
                    ...
                    <p className="text-lg max-w-md text-center">
                        The whole buying process was seamless, and the packaging
                        was elite.
                    </p>
                ...
                <div className="p-2 flex flex-col items-center justify-center space-y-2">
                    <img src={Img3} className="w-32" alt="Customer 3" />
                    ...
                    <p className="text-lg max-w-md text-center">
                        Really soft fiber and quite comfortable. Fits with your
                        body shape.
                    </p>
